...
this.lastKeyPressed_=this.keyTimeout_=null;this.active_=!1;this.finishOnBlur_=!0;this.options.minChars=parseInt(this.options.minChars,10);if(isNaN(this.options.minChars)||1>this.options.minChars)this.options.minChars=l.minChars;this.options.maxItemsToShow=parseInt(this.options.maxItemsToShow,10);if(isNaN(this.options.maxItemsToShow)||1>this.options.maxItemsToShow)this.options.maxItemsToShow=l.maxItemsToShow;this.options.maxCacheLength=parseInt(this.options.maxCacheLength,10);if(isNaN(this.options.maxCacheLength)||
1>this.options.maxCacheLength)this.options.maxCacheLength=l.maxCacheLength;this.dom={};this.dom.$elem=a;this.dom.$elem.attr("autocomplete","off").addClass(this.options.inputClass);this.dom.$results=c("<div></div>").hide().addClass(this.options.resultsClass).css({position:"absolute"});c("body").append(this.dom.$results);a.keydown(function(a){b.lastKeyPressed_=a.keyCode;switch(b.lastKeyPressed_){case 38:return a.preventDefault(),b.active_?b.focusPrev():b.activate(),!1;case 40:return a.preventDefault(),
...
function(a,d){return[a,encodeURIComponent(d)].join("=")};c.Autocompleter.prototype.parseRemoteData=function(a){return"json"===this.options.remoteDataType?this.parseRemoteJSON(a):this.parseRemoteText(a)};c.Autocompleter.prototype.parseRemoteText=function(a){var d=[],b,c,f,h=String(a).replace("\r\n",this.options.lineSeparator).split(this.options.lineSeparator);for(a=0;a<h.length;a++){f=h[a].split(this.options.cellSeparator);c=[];for(b=0;b<f.length;b++)c.push(decodeURIComponent(f[b]));b=c.shift();d.push({value:b,
data:c})}return d};c.Autocompleter.prototype.parseRemoteJSON=function(a){return c.parseJSON(a)};c.Autocompleter.prototype.filterAndShowResults=function(a,c){this.showResults(this.filterResults(a,c),c)};c.Autocompleter.prototype.filterResults=function(a,d){var b=[],e,f,h,g,k;for(h=0;h<a.length;h++)g=a[h],k=typeof g,"string"===k?(e=g,f={}):c.isArray(g)?(e=g[0],f=g.slice(1)):"object"===k&&(e=g.value,f=g.data),e=String(e),""<e&&("object"!==typeof f&&(f={}),this.options.filterResults?(g=this.matchStringConverter(d),
k=this.matchStringConverter(e),this.options.matchCase||(g=g.toLowerCase(),k=k.toLowerCase()),g=k.indexOf(g),g=this.options.matchInside?-1<g:0===g):g=!0,g&&b.push({value:e,data:f}));this.options.sortResults&&(b=this.sortResults(b,d));0<this.options.maxItemsToShow&&this.options.maxItemsToShow<b.length&&(b.length=this.options.maxItemsToShow);return b};c.Autocompleter.prototype.sortResults=function(a,d){var b=this,e=this.options.sortFunction;c.isFunction(e)||(e=function(a,c,d){return b.sortValueAlpha(a,
...
/* assets/snippets/shopkeeper/js/jquery.livequery.js */
